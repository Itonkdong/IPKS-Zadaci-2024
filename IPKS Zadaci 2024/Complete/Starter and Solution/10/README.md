...
• <a name="_hlk157968325"></a>Нa митичките предмети им се добиват "mythical" на нивното име, а при визуелното прикажување на нивната слика потребно е да се користи и СЅЅ класата “blue-filter“.

• Нa легендарните предмети им се добиват "legendary" на нивното име, а при визуелното прикажување на нивната слика потребно е да се користи и СЅЅ класата “red-filter“.
...
1. **Вчитување на рецептите:**
   ...
   • Рецепт-објектот ги специфицира потребните предмети за изработка такашто е наведено кој предмет е потребен во кој слот од таблата и, ако е присутен прашак, кој прашак е потребен во слотот за прашак.
...
1. **Консумација на изработени предмети:**
   ...
   • Дозволување на корисниците да кликаат на било кој од 10-те слотови за "изработени предмети" за да го консумираат изработениот предмет.
...
<a name="_hlk157973638"></a>**Exercise 10:** 
